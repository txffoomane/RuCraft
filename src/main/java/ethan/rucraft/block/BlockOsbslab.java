...
public class BlockOsbslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:osbslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:osbslab_double")
	public static final Block block_slab_double = null;
	public BlockOsbslab(ElementsRucraftMod instance) {
		super(instance, 36);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("osbslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("osbslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:osbslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("osbslab");
