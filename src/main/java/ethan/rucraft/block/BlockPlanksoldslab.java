...
public class BlockPlanksoldslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:planksoldslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("planksoldslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("planksoldslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:planksoldslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("planksoldslab");
