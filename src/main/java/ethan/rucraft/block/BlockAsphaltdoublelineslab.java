...
public class BlockAsphaltdoublelineslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:asphaltdoublelineslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:asphaltdoublelineslab_double")
	public static final Block block_slab_double = null;
	public BlockAsphaltdoublelineslab(ElementsRucraftMod instance) {
		super(instance, 51);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphaltdoublelineslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("asphaltdoublelineslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:asphaltdoublelineslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphaltdoublelineslab");
