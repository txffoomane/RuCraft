...
public class BlockBricksredverticalslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:bricksredverticalslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:bricksredverticalslab_double")
	public static final Block block_slab_double = null;
	public BlockBricksredverticalslab(ElementsRucraftMod instance) {
		super(instance, 72);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bricksredverticalslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("bricksredverticalslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:bricksredverticalslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("bricksredverticalslab");
