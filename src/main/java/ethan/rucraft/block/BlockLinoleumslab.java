...
public class BlockLinoleumslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:linoleumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:linoleumslab_double")
	public static final Block block_slab_double = null;
	public BlockLinoleumslab(ElementsRucraftMod instance) {
		super(instance, 66);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("linoleumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("linoleumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:linoleumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.CLOTH);
			setUnlocalizedName("linoleumslab");
