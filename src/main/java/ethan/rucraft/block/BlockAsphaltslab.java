...
public class BlockAsphaltslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:asphaltslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:asphaltslab_double")
	public static final Block block_slab_double = null;
	public BlockAsphaltslab(ElementsRucraftMod instance) {
		super(instance, 45);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphaltslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("asphaltslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:asphaltslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphaltslab");
