...
public class BlockConcretepaintedbluedestroedslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:concretepaintedbluedestroedslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:concretepaintedbluedestroedslab_double")
	public static final Block block_slab_double = null;
	public BlockConcretepaintedbluedestroedslab(ElementsRucraftMod instance) {
		super(instance, 24);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("concretepaintedbluedestroedslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("concretepaintedbluedestroedslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:concretepaintedbluedestroedslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("concretepaintedbluedestroedslab");
