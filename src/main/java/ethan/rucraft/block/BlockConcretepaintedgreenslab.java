...
public class BlockConcretepaintedgreenslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:concretepaintedgreenslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:concretepaintedgreenslab_double")
	public static final Block block_slab_double = null;
	public BlockConcretepaintedgreenslab(ElementsRucraftMod instance) {
		super(instance, 15);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("concretepaintedgreenslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("concretepaintedgreenslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:concretepaintedgreenslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("concretepaintedgreenslab");
