...
public class BlockBricksredslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:bricksredslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:bricksredslab_double")
	public static final Block block_slab_double = null;
	public BlockBricksredslab(ElementsRucraftMod instance) {
		super(instance, 6);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bricksredslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("bricksredslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:bricksredslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("bricksredslab");
