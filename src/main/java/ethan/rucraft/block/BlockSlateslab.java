...
public class BlockSlateslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:slateslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:slateslab_double")
	public static final Block block_slab_double = null;
	public BlockSlateslab(ElementsRucraftMod instance) {
		super(instance, 63);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slateslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slateslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:slateslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("slateslab");
