...
public class BlockBrickswhitevertical extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:brickswhitevertical")
	public static final Block block = null;
	public BlockBrickswhitevertical(ElementsRucraftMod instance) {
		super(instance, 67);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brickswhitevertical"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:brickswhitevertical", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brickswhitevertical");
