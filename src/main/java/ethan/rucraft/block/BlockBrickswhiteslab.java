...
public class BlockBrickswhiteslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:brickswhiteslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:brickswhiteslab_double")
	public static final Block block_slab_double = null;
	public BlockBrickswhiteslab(ElementsRucraftMod instance) {
		super(instance, 3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brickswhiteslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brickswhiteslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:brickswhiteslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brickswhiteslab");
