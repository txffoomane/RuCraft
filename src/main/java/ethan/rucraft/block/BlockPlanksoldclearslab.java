...
public class BlockPlanksoldclearslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:planksoldclearslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:planksoldclearslab_double")
	public static final Block block_slab_double = null;
	public BlockPlanksoldclearslab(ElementsRucraftMod instance) {
		super(instance, 82);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("planksoldclearslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("planksoldclearslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:planksoldclearslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("planksoldclearslab");
