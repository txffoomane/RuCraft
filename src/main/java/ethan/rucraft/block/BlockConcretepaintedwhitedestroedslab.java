...
public class BlockConcretepaintedwhitedestroedslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:concretepaintedwhitedestroedslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:concretepaintedwhitedestroedslab_double")
	public static final Block block_slab_double = null;
	public BlockConcretepaintedwhitedestroedslab(ElementsRucraftMod instance) {
		super(instance, 42);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("concretepaintedwhitedestroedslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("concretepaintedwhitedestroedslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:concretepaintedwhitedestroedslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("concretepaintedwhitedestroedslab");
