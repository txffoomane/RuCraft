...
public class BlockBricksredvertical extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:bricksredvertical")
	public static final Block block = null;
	public BlockBricksredvertical(ElementsRucraftMod instance) {
		super(instance, 70);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bricksredvertical"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:bricksredvertical", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("bricksredvertical");
