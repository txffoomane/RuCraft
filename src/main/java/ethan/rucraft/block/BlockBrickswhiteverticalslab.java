...
public class BlockBrickswhiteverticalslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:brickswhiteverticalslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:brickswhiteverticalslab_double")
	public static final Block block_slab_double = null;
	public BlockBrickswhiteverticalslab(ElementsRucraftMod instance) {
		super(instance, 69);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brickswhiteverticalslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brickswhiteverticalslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:brickswhiteverticalslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brickswhiteverticalslab");
