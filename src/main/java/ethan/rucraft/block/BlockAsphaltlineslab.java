...
public class BlockAsphaltlineslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:asphaltlineslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:asphaltlineslab_double")
	public static final Block block_slab_double = null;
	public BlockAsphaltlineslab(ElementsRucraftMod instance) {
		super(instance, 48);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphaltlineslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("asphaltlineslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:asphaltlineslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphaltlineslab");
