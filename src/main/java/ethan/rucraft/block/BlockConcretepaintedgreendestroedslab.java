...
public class BlockConcretepaintedgreendestroedslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:concretepaintedgreendestroedslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:concretepaintedgreendestroedslab_double")
	public static final Block block_slab_double = null;
	public BlockConcretepaintedgreendestroedslab(ElementsRucraftMod instance) {
		super(instance, 27);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("concretepaintedgreendestroedslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("concretepaintedgreendestroedslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:concretepaintedgreendestroedslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("concretepaintedgreendestroedslab");
