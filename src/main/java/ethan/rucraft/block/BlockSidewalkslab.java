...
public class BlockSidewalkslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:sidewalkslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sidewalkslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sidewalkslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:sidewalkslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("sidewalkslab");
