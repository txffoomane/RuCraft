...
public class BlockCorrugatedsheetsslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:corrugatedsheetsslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("corrugatedsheetsslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("corrugatedsheetsslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:corrugatedsheetsslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("corrugatedsheetsslab");
