...
public class BlockConcretepaintedreddestroedslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:concretepaintedreddestroedslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:concretepaintedreddestroedslab_double")
	public static final Block block_slab_double = null;
	public BlockConcretepaintedreddestroedslab(ElementsRucraftMod instance) {
		super(instance, 30);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("concretepaintedreddestroedslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("concretepaintedreddestroedslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:concretepaintedreddestroedslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("concretepaintedreddestroedslab");
