...
public class BlockCinderblockslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:cinderblockslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:cinderblockslab_double")
	public static final Block block_slab_double = null;
	public BlockCinderblockslab(ElementsRucraftMod instance) {
		super(instance, 33);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cinderblockslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cinderblockslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rucraft:cinderblockslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("cinderblockslab");
