...
public class BlockMetalrustslab extends ElementsRucraftMod.ModElement {
	@GameRegistry.ObjectHolder("rucraft:metalrustslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rucraft:metalrustslab_double")
	public static final Block block_slab_double = null;
	public BlockMetalrustslab(ElementsRucraftMod instance) {
		super(instance, 54);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("metalrustslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("metalrustslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("rucraft:metalrustslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("metalrustslab");
